...
# Re-export markdown/PDF helpers for backward compatibility (tests and other
# modules import these names from generate_report).
from report.generate_report_pdf import (  # noqa: F401  # type: ignore
    markdown_to_html,
    html_to_pdf,
    _html_to_pdf_weasyprint,
    _html_to_pdf_browser,
)
