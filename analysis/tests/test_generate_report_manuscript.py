"""Tests for manuscript and publication-related report sections.

Covers:
- _section_manuscript_ready_findings: AUC/HR/treatment response sentences
- _section_reporting_checklist: STROBE/REMARK checklist
