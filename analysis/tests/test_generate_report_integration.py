...
Covers:
- generate_report: end-to-end report with graph CSV, logs, empty folders
- Data quality outlier balance and bias detection
- Cox PH direction column in survival tables
- Correlations interpretation context
- New sections integration (checklist, BibTeX, STROBE, results draft, gallery, journal guide)
"""
...
from report.generate_report import generate_report  # type: ignore
