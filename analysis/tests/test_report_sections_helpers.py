"""Tests for report_sections._helpers module (base behaviour).
...
Edge-case tests for these helpers live in
test_report_sections_helpers_edge_cases.py. Shared imports live in
_test_report_sections_helpers_shared.py.
"""
