...
Tests the non-API-dependent functions (part 1):
...
Timeout config, rate-limit detection/coordination, CLI flag parsing, local
fallback, shared response parsing, and dual-provider comparison live in
test_batch_graph_analysis_part2.py (file-size split).
