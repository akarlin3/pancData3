...
│   └── tests/                  # Python test suite — 10 test files, 313 tests (pytest)
...
**Python Test Suite (pytest):** 10 test files with 313 tests in `analysis/tests/`. Run with `cd analysis/tests && python -m pytest -v`.
