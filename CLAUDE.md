...
│   │   └── sections/                   # Section builders (11 files)
│   └── tests/                          # Python test suite — 22 test files, 653 tests (pytest)
├── .agents/
