...
│   └── tests/                  # Python test suite — 7 test files, 142 tests (pytest)
...
**Python Test Suite (pytest):** 7 test files with 142 tests in `analysis/tests/`. Run with `cd analysis/tests && python -m pytest -v`.
