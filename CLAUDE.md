...
| `test_integration.py` | End-to-end pipeline integration: runs run_analysis.py on synthetic data, verifies HTML report sections, tables, figures, metadata, navigation, and graceful empty-folder handling |
