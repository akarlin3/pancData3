...
function test_core_methods()
    ...
    config_struct.min_vox_hist = 50; % Small for test array
    ...
    % Setup mock parameter maps (100 voxels)
    rng(42); % For reproducibility
    % 30 distinct low ADC "core" voxels, 70 distinct high ADC voxels
    ...
    % Setup mock 3D geometry (10x10x1)
    has_3d = true;
    gtv_mask_3d = true(10, 10, 1);
