...
3. Run 'matlab -batch "try, execute_all_workflows.m, catch ME, disp(getReport(ME, 'extended')), whos, exit(1), end" > debug.log 2>&1'
...
- Add the logs and any modified scripts: 'git add debug.log *.m'
