...
[![Tests](https://img.shields.io/badge/tests-92%20MATLAB%20%2B%2022%20Python%20files-brightgreen)](#running-tests)
...
The analysis scripts have a comprehensive Python test suite (972 tests across 23 files) using pytest:
...
│   └── tests/                      #   Python test suite (23 test files, 972 tests)
