...
% plot_scatter_correlations.m which reports full-cohort and per-group
% (LC/LF) Spearman + trend lines with outcome-coloured markers, competing
% risk display, and Octave compatibility.
