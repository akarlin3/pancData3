...
for target_fx = 2:nTp
    ...
    % Delegated to build_predictive_feature_metadata to keep this file under
    % the per-file line budget.  Returns the per-significant-feature arrays
    % (sig_*) consumed by the diagnostic plots below.
    [n_sig, sig_data_selected, sig_names, sig_is_abs, ...
